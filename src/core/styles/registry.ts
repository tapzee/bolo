...
> = {
  ...
  designWallaEditorial: define(
    "designWallaEditorial",
    "Design Walla Editorial",
    "Signature 3-row layout with heavy condensed punch words, elegant italic serif flourishes, and clean connector text.",
    {
      fontId: "anton",
  ...
  designWallaEditorialYellow: define(
    "designWallaEditorialYellow",
    "Design Walla Editorial (Yellow)",
    "Signature 3-row layout with glowing yellow punch words, elegant italic serif accents, and clean support text.",
    {
      fontId: "anton",
      secondaryFontId: "inter",
      specialFontId: "playfair",
  ...
  popWord: define(
    "popWord",
    "Pop Word",
    "Punchy word-by-word reveal with role-based micro-tilts, elastic bounce, and glowing highlights.",
    {
      fontId: "montserrat",
      fontWeight: 900,
      fontSizePx: 96,
  ...
  dualLine: define(
    "dualLine",
    "Dual Line Pro",
    "Two-line overlay layout with bold all-caps top and elegant cursive script bottom.",
    {
      fontId: "anton",
