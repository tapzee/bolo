...
const PHRASES: SamplePhrase[] = [
  ...
  {
    id: "hindi",
    label: "αñ╣αñ┐αñ¿αÑìαñªαÑÇ (Devanagari)",
    lang: "Hindi",
    words: [
      { text: "αñàαñùαñ░" },
      { text: "αñåαñ¬" },
      { text: "αñ¡αÑÇ" },
      { text: "αñòαñéαñƒαÑçαñéαñƒ", highlight: true, color: "#10b981" },
      { text: "αñ¼αñ¿αñ╛αññαÑç" },
      { text: "αñ╣αÑêαñé," },
      { text: "αññαÑï", highlight: true, color: "#34d399" },
      { text: "αñ»αñ╣" },
      { text: "αñ╕αÑüαñ¿αñ┐αñÅ!" },
    ],
  },
  {
    id: "hook",
...
export function Hero3DSection() {
  ...
  const marqueeText = "Yeh simple trick aapke reels ko 10X viral karegi ΓÇó Auto-punctuated Hinglish captions in seconds ΓÇó ";
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-16 sm:pt-24 z-10">
        ...
        <div className="mx-auto max-w-4xl text-center relative z-10">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-[10px] text-muted-foreground/60 uppercase tracking-widest font-bold mt-1">
              No card required ΓÇó 100% In-browser Privacy
            </p>
        ...
        {/* ===================================================================
            1B. LIVE SYNC RIBBON ROW ΓÇö clean, non-overlapping wavy banner + pills
           =================================================================== */}
        <div className="relative mt-20 sm:mt-24 mx-auto max-w-4xl px-6 sm:px-0">
          ...
          {/* Wavy ribbon banner ΓÇö desktop: real curved SVG path, mobile: simplified straight strip */}
            ...
            <div className="relative aspect-[9/16] w-full overflow-hidden rounded-[34px] bg-gradient-to-b from-neutral-900 via-neutral-950 to-neutral-900 flex flex-col justify-between p-4 shadow-inner">
              ...
              <div className="relative z-20 text-left pb-2">
                ...
                <p className="text-[11px] text-white/80 line-clamp-1 mt-0.5">
                  Viral Hinglish reel made with CutXflow ΓÜí
                </p>
